      ...
      <div className="my-4 stats inline-grid md:flex  shadow stats-vertical   md:stats-horizontal">
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/orders">Savdolarni korish</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/orders">Buyurtmalarni korish</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/products">Mahsulotlarni korish</Link>
          </div>
        </div>
        <div className="stat">
          ...
          <div className="stat-desc">
            <Link href="/admin/users">Foydalanuvchilarni korish</Link>
          </div>
        </div>
      </div>
