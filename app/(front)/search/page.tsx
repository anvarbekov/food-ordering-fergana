  ...
  return (
    <div className="grid md:grid-cols-5 md:gap-5">
      <div>
        ...
        <div>
          <div className="text-xl pt-3">Narxlar</div>
          <ul>
            <li>
              <Link
                className={`link link-hover ${
        ...
        <div>
          <div className="text-xl pt-3">Mijozlarni korib chiqish</div>
          <ul>
            <li>
              <Link
      ...
      <div className="md:col-span-4">
        <div className="flex items-center justify-between  py-4">
          <div className="flex items-center">
            {products.length === 0 ? 'No' : countProducts} Natija
            {q !== 'all' && q !== '' && ' : ' + q}
            {category !== 'all' && ' : ' + category}
            {price !== 'all' && ' : Price ' + price}
            {rating !== 'all' && ' : Rating ' + rating + ' & yuqoriga'}
            &nbsp;
            {(q !== 'all' && q !== '') ||
            category !== 'all' ||
            rating !== 'all' ||
