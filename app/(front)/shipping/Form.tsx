    ...
    <div>
      ...
      <div className="max-w-sm mx-auto card bg-base-300 my-4">
        <div className="card-body">
          ...
          <form className='sign-in-form' onSubmit={handleSubmit(formSubmit)}>
            <FormInput name="Toliq ismingiz" id="fullName" required />
            <FormInput name="Manzilingiz" id="address" required />
            <FormInput name="Shahringiz" id="city" required />
